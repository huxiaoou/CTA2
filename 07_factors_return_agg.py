from setup_factor_and_portfolio import os, sys, pd
from setup_factor_and_portfolio import factors_return_dir, instruments_residual_dir
from setup_factor_and_portfolio import factors_return_agg_dir, instruments_residual_agg_dir
...
factors_return_lag = int(sys.argv[3])
...
instruments_residual_lib.set_default(database_structure[instruments_residual_lib_id].m_tab.m_table_name)
...
instruments_residual_df = instruments_residual_lib.read(t_value_columns=["trade_date", "instrument", "value"])

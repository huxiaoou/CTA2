...
sp.run(["python", "00_C_available_universe.py", "--mode", "a", "--bgn", trade_date])
print(sep)

sp.run(["python", "01_market_index.py"])
print(sep)

sp.run(["python", "02_test_return.py", "--mode", "a", "--bgn", trade_date])
print(sep)

sp.run(["python", "02_test_return_neutral.py", "--mode", "a", "--bgn", trade_date])
print(sep)
